  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (serviceId && templateId && publicKey) {
        ...
        console.log("Form submitted (Local Mock):", formData)
      }
  ...
  const socialLinks = [
    {
      ...
      detail: 'nikhilkumarjain.dev@gmail.com',
    ...
    },
    {
      ...
      detail: 'linkedin.com/in/nikhil-kumar-jain',
    ...
    },
    {
      ...
      detail: 'github.com/nikhil-kumar-jain',
              ...
              <AnimatePresence>
                {submitStatus === 'success' && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 10 }}
                    className="mt-6 p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center gap-3 text-sm"
                  >
                    <CheckCircle2 size={18} className="shrink-0" />
                    <span>Thank you! Your message was sent successfully. Nikhil will contact you shortly.</span>
                  </motion.div>
                )}
                ...
                {submitStatus === 'error' && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: 10 }}
                    className="mt-6 p-4 rounded-lg bg-rose-500/10 border border-rose-500/20 text-rose-400 flex items-center gap-3 text-sm"
                  >
